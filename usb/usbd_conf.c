/**
  ******************************************************************************
  * @file    USB_Device/CDC_ECM_Server/Src/usbd_conf.c
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_FS, 0, 0x20);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_FS, 1, 0x20);
  ...
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 0, 0x10);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 1, 0x140);
  (void)HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 2, 0x10);
#endif
